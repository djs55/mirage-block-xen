...
(* OASIS_START *)
(* DO NOT EDIT (digest: 26c7cf46d675827c25609bd0508c0abe) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the frontend driver";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the backend driver";
                      flag_default = [(OASISExpr.EBool true, true)];
                      });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Blkproto"; "Blkstats"; "Device_number"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\222\131hK\137\011\181\b]\173E\143\238\250!\141";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
